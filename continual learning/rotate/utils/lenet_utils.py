...
class LeNet:
    ...
    def compute_svd_high(self, sess):
            # Compute svd of REWC
            self.weights_svd = []
            self.weights_w = []
            for v in range(len(self.var_list)):
                ...
                if not self.doDecom[v]:
                    ...
                    if len(self.weights_w[v*4].shape)==2:
                        ...
                        if len(self.weights_w[v*4].shape)==4:
                            # it's a convolutional layer
                            W = self.weights_w[v*4+1]
                            #W = self.weights_w[v*4] + self.weights_w[v*4+1] + self.weights_w[v*4+2] -2
                            print("Q1 shape:{}".format(Q1.shape))
                            print("Q2 shape:{}".format(Q2.shape))
                            print("W original shape:{}".format(self.weights_w[v*4].shape))
                            print("W original shape:{}".format(self.weights_w[v*4+1].shape))
                            print("W original shape:{}".format(self.weights_w[v*4+2].shape))
